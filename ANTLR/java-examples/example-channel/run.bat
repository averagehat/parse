...
echo Running the test rig on the CSV data
java org.antlr.v4.gui.TestRig My csv -gui < input-csv.txt
echo.
echo.

REM echo Running the test rig on the Key/Value data
REM java org.antlr.v4.gui.TestRig My keyValue -gui < input-keyValue.txt
REM echo.
REM echo.