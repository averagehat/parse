...
public class MyParser extends Parser {
	...
	public static final int
		STRING=1, DELIMITER=2;
	public static final int
		RULE_input = 0, RULE_string = 1, RULE_delimiter = 2;
	...
	public final InputContext input() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (_la==STRING || _la==DELIMITER) {
				{
				setState(8);
				switch (_input.LA(1)) {
				case STRING:
	...
	public static class DelimiterContext extends ParserRuleContext {
		public TerminalNode DELIMITER() { return getToken(MyParser.DELIMITER, 0); }
	...
	public final DelimiterContext delimiter() throws RecognitionException {
		...
		enterRule(_localctx, 4, RULE_delimiter);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(15);
	...
	public static final String _serializedATN =
		...
		"\2\2\r\3\3\2\2\2\16\f\3\2\2\2\17\20\7\3\2\2\20\5\3\2\2\2\21\22\7\4\2\2"+
		"\22\7\3\2\2\2\4\n\f";
