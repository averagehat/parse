...
echo Compiling the Java code that ANTLR generator (the parser code)
javac *.java
echo.
echo.
...
java org.antlr.v4.gui.TestRig MyParser file -gui < input.txt

rem java org.antlr.v4.gui.TestRig MyParser tokens -tokens  < input.txt
echo.
echo.