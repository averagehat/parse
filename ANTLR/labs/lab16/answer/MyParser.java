...
public class MyParser extends Parser {
	...
	public static final int
		RULE_classifications = 0, RULE_classification = 1;
	...
	public static class ClassificationsContext extends ParserRuleContext {
		...
		public List<ClassificationContext> classification() {
			return getRuleContexts(ClassificationContext.class);
		}
		public ClassificationContext classification(int i) {
			return getRuleContext(ClassificationContext.class,i);
		}
	...
	public final ClassificationsContext classifications() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_classifications);
		int _la;
		try {
	...
	public static class ClassificationContext extends ParserRuleContext {
		public TerminalNode CLASSIFICATION() { return getToken(MyParser.CLASSIFICATION, 0); }
	...
	public final ClassificationContext classification() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_classification);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(12);
