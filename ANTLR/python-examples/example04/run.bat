...
echo Show the tree
echo python pygrun.py -t My intfile input.txt 
python pygrun.py -t My intfile input.txt

rem echo Show the tokens
rem echo python pygrun.py -k My intfile input.txt 
rem python pygrun.py -k My intfile input.txt

rem echo Show the trace
rem echo python pygrun.py -a My intfile input.txt 
rem python pygrun.py -a My intfile input.txt
