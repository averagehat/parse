...
echo Show the tree
echo python pygrun.py -t My file input.txt 
python pygrun.py -t My file input.txt

rem echo Show the tokens
rem echo python pygrun.py -k My file input.txt 
rem python pygrun.py -k My file input.txt

rem echo Show the trace
rem echo python pygrun.py -a My file input.txt 
rem python pygrun.py -a My file input.txt
