...
echo Show the tree
echo python pygrun.py -t My memberNamePair input.txt 
python pygrun.py -t My memberNamePair input.txt

rem echo Show the tokens
rem echo python pygrun.py -k My memberNamePair input.txt 
rem python pygrun.py -k My memberNamePair input.txt

rem echo Show the trace
rem echo python pygrun.py -a My memberNamePair input.txt 
rem python pygrun.py -a My memberNamePair input.txt
